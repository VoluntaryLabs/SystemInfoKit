...
static SINetworkMonitor *sharedSINetworkMonitor = nil;

@implementation SINetworkMonitor

+ (SINetworkMonitor *)sharedSINetworkMonitor
{
    if (sharedSINetworkMonitor == nil)
    {
        sharedSINetworkMonitor = [[SINetworkMonitor alloc] init];
    }
    
    return sharedSINetworkMonitor;
}
...
- (void)setSSID:(NSString *)newSsid
{
        ...
        )
    {
        ...
        _ssid = newSsid;
        [[NSNotificationCenter defaultCenter] postNotificationName:SINetworkMonitorChangeNotification
                                                            object:self
                                                          userInfo:nil];
    }
}
